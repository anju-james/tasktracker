defmodule TasktrackerWeb.IssueControllerTest do
  use TasktrackerWeb.ConnCase

  alias Tasktracker.Tasks

  @create_attrs %{completed: true, description: "some description", time_spent_mins: 42, title: "some title"}
  ...
  def fixture(:issue) do
    {:ok, issue} = Tasks.create_issue(@create_attrs)
    issue
  end
